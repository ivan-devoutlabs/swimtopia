            ...
            <div class="blog__filterWrapper">
                <div class="blog__filterActive">
                    <?php foreach ( $selected as $term_id ) : ?>
                        <?php $term = get_term( $term_id, 'webinars-categories' ); ?>
                ...
                <div class="blog__filterList__wrapper">
                    ...
                    <div class="blog__filterList">
                        <?php foreach ( $terms as $term ) : ?>
                            ...
                            $next = $is_active ? array_diff( $selected, array( $term->term_id ) ) : array_merge( $selected, array( $term->term_id ) );
                            $href = $next ? add_query_arg( 'cats', implode( ',', $next ), $base_url ) : $base_url;
                            ?>
                            <a class="blog__filterList__item<?php echo $is_active ? ' is-active' : ''; ?>" href="<?php echo esc_url( $href ); ?>" data-term="<?php echo esc_attr( $term->term_id ); ?>" aria-pressed="<?php echo $is_active ? 'true' : 'false'; ?>">
